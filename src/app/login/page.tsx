    ...
    <div className="min-h-screen bg-gray-950 flex items-center justify-center p-4">
      <div className="w-full max-w-md">
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-gray-400">Log in to access your subscriptions</p>
        </div>
        ...
        <button
          ...
          disabled={loading}
          className="w-full py-3 rounded-lg font-medium text-sm bg-gray-900 border border-gray-800 hover:border-gray-700 text-white transition-colors flex items-center justify-center gap-2"
        >
